...
public class FollowVision extends Command {
  ...
  public double k1 = -0.02; // this is negative as a larger value means we are closer to the target 
  // TODO: tune this ^
  public double k2 = 0.004; // TODO: tune this
  public double k3 = -.0025; // TODO: tune this
  ...
  protected void execute() {
    if (!Robot.camera.hasTarget()) {
      ...
      double hRatioValue = hRatioError * k3;
